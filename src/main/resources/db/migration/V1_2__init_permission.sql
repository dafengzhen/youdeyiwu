...
VALUES  (1, null, now(), false, null, now(), 0, '[users] POST users/register', false, 2, '/users/register', null, 0, 0, null),
        ...
        (17, null, now(), false, null, now(), 0, '[users] DELETE users/{id}', false, 0, '/users/{id}', null, 0, 0, null),
        ...
        (20, null, now(), false, null, now(), 0, '[roles] GET roles', false, 2, '/roles', null, 0, 0, null),
        ...
        (24, null, now(), false, null, now(), 0, '[roles] GET roles/{id}/permissions', false, 3, '/roles/{id}/permissions', null, 0, 0, null),
        (25, null, now(), false, null, now(), 0, '[roles] GET roles/{id}/permissions', false, 0, '/roles/{id}/permissions', null, 0, 0, null),
        (26, null, now(), false, null, now(), 0, '[roles] DELETE roles/{id}', false, 3, '/roles/{id}', null, 0, 0, null),
        (27, null, now(), false, null, now(), 0, '[roles] DELETE roles/{id}', false, 0, '/roles/{id}', null, 0, 0, null),
        (28, null, now(), false, null, now(), 0, '[roles] DELETE roles/{id}', false, 5, '/roles/{id}', null, 0, 0, null),
        (29, null, now(), false, null, now(), 0, '[permissions] GET permissions', false, 2, '/permissions', null, 0, 0, null),
        ...
        (32, null, now(), false, null, now(), 0, '[permissions] DELETE permissions/{id}', false, 3, '/permissions/{id}', null, 0, 0, null),
        (33, null, now(), false, null, now(), 0, '[permissions] DELETE permissions/{id}', false, 0, '/permissions/{id}', null, 0, 0, null),
        (34, null, now(), false, null, now(), 0, '[permissions] DELETE permissions/{id}', false, 5, '/permissions/{id}', null, 0, 0, null),
        (35, null, now(), false, null, now(), 0, '[menus] GET menus', false, 2, '/menus', null, 0, 0, null),
        ...
        (38, null, now(), false, null, now(), 0, '[menus] DELETE menus/{id}', false, 3, '/menus/{id}', null, 0, 0, null),
        (39, null, now(), false, null, now(), 0, '[menus] DELETE menus/{id}', false, 0, '/menus/{id}', null, 0, 0, null),
        (40, null, now(), false, null, now(), 0, '[menus] DELETE menus/{id}', false, 5, '/menus/{id}', null, 0, 0, null),
        (41, null, now(), false, null, now(), 0, '[submenus] GET submenus', false, 2, '/submenus', null, 0, 0, null),
        ...
        (44, null, now(), false, null, now(), 0, '[submenus] DELETE submenus/{id}', false, 3, '/submenus/{id}', null, 0, 0, null),
        (45, null, now(), false, null, now(), 0, '[submenus] DELETE submenus/{id}', false, 0, '/submenus/{id}', null, 0, 0, null),
        (46, null, now(), false, null, now(), 0, '[submenus] DELETE submenus/{id}', false, 5, '/submenus/{id}', null, 0, 0, null),
        (47, null, now(), false, null, now(), 0, '[actions] GET actions', false, 2, '/actions', null, 0, 0, null),
        (48, null, now(), false, null, now(), 0, '[actions] GET actions', false, 0, '/actions', null, 0, 0, null),
        (49, null, now(), false, null, now(), 0, '[actions] PUT actions/{id}/role', false, 3, '/actions/{id}/role', null, 0, 0, null),
        (50, null, now(), false, null, now(), 0, '[actions] DELETE actions/{id}', false, 3, '/actions/{id}', null, 0, 0, null),
        (51, null, now(), false, null, now(), 0, '[actions] DELETE actions/{id}', false, 0, '/actions/{id}', null, 0, 0, null),
        (52, null, now(), false, null, now(), 0, '[actions] DELETE actions/{id}', false, 5, '/actions/{id}', null, 0, 0, null),
        (53, null, now(), false, null, now(), 0, '[points] GET points/rules', false, 2, '/points/rules', null, 0, 0, null),
        (54, null, now(), false, null, now(), 0, '[points] GET points/rules', false, 0, '/points/rules', null, 0, 0, null),
        (55, null, now(), false, null, now(), 0, '[points] GET points/permission-rules', false, 2, '/points/permission-rules', null, 0, 0, null),
        ...
        (58, null, now(), false, null, now(), 0, '[messages] GET messages/global-messages', false, 2, '/messages/global-messages', null, 0, 0, null),
        (59, null, now(), false, null, now(), 0, '[messages] GET messages/global-messages', false, 0, '/messages/global-messages', null, 0, 0, null),
        (60, null, now(), false, null, now(), 0, '[messages] GET messages', false, 2, '/messages', null, 0, 0, null),
        ...
        (65, null, now(), false, null, now(), 0, '[messages] DELETE messages/{id}', false, 0, '/messages/{id}', null, 0, 0, null),
        ...
        (68, null, now(), false, null, now(), 0, '[configs] PUT configs/jwt', false, 0, '/configs/jwt', null, 0, 0, null),
        ...
        (71, null, now(), false, null, now(), 0, '[configs] PUT configs/point', false, 0, '/configs/point', null, 0, 0, null),
        (72, null, now(), false, null, now(), 0, '[configs] PUT configs/point', false, 3, '/configs/point', null, 0, 0, null),
        (73, null, now(), false, null, now(), 0, '[sections] GET sections', false, 2, '/sections', null, 0, 0, null),
        ...
        (80, null, now(), false, null, now(), 0, '[sections] DELETE sections/{id}', false, 3, '/sections/{id}', null, 0, 0, null),
        (81, null, now(), false, null, now(), 0, '[sections] DELETE sections/{id}', false, 0, '/sections/{id}', null, 0, 0, null),
        ...
        (86, null, now(), false, null, now(), 0, '[tags] GET tags', false, 2, '/tags', null, 0, 0, null),
        (87, null, now(), false, null, now(), 0, '[tags] GET tags', false, 0, '/tags', null, 0, 0, null),
        (88, null, now(), false, null, now(), 0, '[tags] DELETE tags/{id}', false, 3, '/tags/{id}', null, 0, 0, null),
        (89, null, now(), false, null, now(), 0, '[tags] DELETE tags/{id}', false, 0, '/tags/{id}', null, 0, 0, null),
        ...
        (92, null, now(), false, null, now(), 0, '[posts] GET posts', false, 2, '/posts', null, 0, 0, null),
        ...
        (101, null, now(), false, null, now(), 0, '[posts] DELETE posts/{id}', false, 3, '/posts/{id}', null, 0, 0, null),
        (102, null, now(), false, null, now(), 0, '[posts] DELETE posts/{id}', false, 0, '/posts/{id}', null, 0, 0, null),
        ...
        (115, null, now(), false, null, now(), 0, '[section-groups] GET section-groups', false, 2, '/section-groups', null, 0, 0, null),
        ...
        (118, null, now(), false, null, now(), 0, '[section-groups] DELETE section-groups/{id}', false, 3, '/section-groups/{id}', null, 0, 0, null),
        (119, null, now(), false, null, now(), 0, '[section-groups] DELETE section-groups/{id}', false, 0, '/section-groups/{id}', null, 0, 0, null),
        ...
        (125, null, now(), false, null, now(), 0, '[tag-groups] DELETE tag-groups/{id}', false, 3, '/tag-groups/{id}', null, 0, 0, null),
        (126, null, now(), false, null, now(), 0, '[tag-groups] DELETE tag-groups/{id}', false, 0, '/tag-groups/{id}', null, 0, 0, null),
